...
model = net.get_model()
print(model.summary())
if(os.path.exists('checkpoints/model_1.weights.hdf5')):
    model.load_weights('checkpoints/model_1.weights.hdf5')
...
weighted_ce_with_logits = net.custom_ce_loss#net.cross_entropy_balanced
