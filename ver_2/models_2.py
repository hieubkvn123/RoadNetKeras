...
class RoadSurfaceNet(object):
    ...
    def get_model(self):
        ...
        ### First output ###
        ### Size = W * H * 1 ###
        side_1 = Conv2D(1, kernel_size=(1,1), padding='same', name='surface_output_1')(conv_1)
        ...
        ### Second output ###
        ### Size = W/2 * H/2 * 1 ###
        side_2 = Conv2D(1, kernel_size=(1,1))(conv_2)
        ...
        ### Third output ###
        ### Size = W/4 * H/4 * 1 ###
        side_3 = Conv2D(1, kernel_size=(1,1))(conv_3)
        ...
        ### Fourth output ###
        ### Size = W/8 * H/8 * 1 ###
        side_4 = Conv2D(1, kernel_size=(1,1))(conv_4)
        ...
        ### Fifth output ###
        ### Size = W/16 * H/16 * 1 ###
        side_5 = Conv2D(1, kernel_size=(1,1))(conv_5)
        ...
        concat = Conv2D(1, kernel_size=(1,1), name='surface_concat', kernel_regularizer=l2(1e-4))(concat)
        concat = (tf.nn.sigmoid(concat) - 0.5) / 0.5
...
class SideNet(object):
    ...
    def get_model(self):
        ...
        ### First output ###
        side_1 = Conv2D(1, kernel_size=(1,1), name=self.name+'_output_1')(conv_1)
        ...
        concat = Conv2D(1, kernel_size=(1,1), name=self.name+'_concat', kernel_regularizer=l2(1e-4))(concat) 
        concat = (tf.nn.sigmoid(concat) - 0.5)/0.5
