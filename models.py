...
class RoadSurfaceNet(object):
    ...
    def get_model(self):
        ...
        ### First output ###
        ### Size = W * H * 1 ###
        side_1 = Conv2D(1, kernel_size=(1,1), activation='sigmoid', padding='same', name='surface_output_1', kernel_regularizer=l2(1e-4))(conv_1)
        ...
        ### Second output ###
        ### Size = W/2 * H/2 * 1 ###
        side_2 = Conv2D(1, kernel_size=(1,1), activation='sigmoid')(conv_2)
        side_2 = Conv2DTranspose(1, kernel_size=(2,2), strides=(2,2), padding='same', name='surface_output_2', kernel_regularizer=l2(1e-4))(side_2)
        ...
        ### Third output ###
        ### Size = W/4 * H/4 * 1 ###
        side_3 = Conv2D(1, kernel_size=(1,1), activation='sigmoid')(conv_3)
        side_3 = Conv2DTranspose(1, kernel_size=(4,4), strides=(4,4), padding='same', name='surface_output_3', kernel_regularizer=l2(1e-4))(side_3)
        ...
        ### Fourth output ###
        ### Size = W/8 * H/8 * 1 ###
        side_4 = Conv2D(1, kernel_size=(1,1), activation='sigmoid')(conv_4)
        side_4 = Conv2DTranspose(1, kernel_size=(8,8), strides=(8,8), padding='same', name='surface_output_4', kernel_regularizer=l2(1e-4))(side_4)
        ...
        ### Fifth output ###
        ### Size = W/16 * H/16 * 1 ###
        side_5 = Conv2D(1, kernel_size=(1,1), activation='sigmoid')(conv_5)
        side_5 = Conv2DTranspose(1, kernel_size=(16,16), strides=(16,16), padding='same', name='surface_output_5', kernel_regularizer=l2(1e-4))(side_5)
        ...
        concat = Conv2D(1, kernel_size=(1,1), activation='sigmoid', name='surface_concat', kernel_regularizer=l2(1e-4))(concat)
...
class SideNet(object):
    ...
    def get_model(self):
        ...
        ### First output ###
        side_1 = Conv2D(1, kernel_size=(1,1), activation='sigmoid', name=self.name+'_output_1', kernel_regularizer=l2(1e-4))(conv_1)
        ...
        ### Second output ###
        side_2 = Conv2D(1, kernel_size=(1,1), activation='sigmoid')(conv_2)
        side_2 = Conv2DTranspose(1, kernel_size=(2,2), strides=(2,2), padding='same', name=self.name+'_output_2', kernel_regularizer=l2(1e-4))(side_2)
        ...
        ### Third output ###
        side_3 = Conv2D(1, kernel_size=(1,1), activation='sigmoid')(conv_3)
        side_3 = Conv2DTranspose(1, kernel_size=(4,4), strides=(4,4), padding='same', name=self.name+'_output_3', kernel_regularizer=l2(1e-4))(side_3)
        ...
        ### Fourth output ###
        side_4 = Conv2D(1, kernel_size=(1,1), activation='sigmoid')(conv_4)
        side_4 = Conv2DTranspose(1, kernel_size=(8,8), strides=(8,8), padding='same', name=self.name+'_output_4', kernel_regularizer=l2(1e-4))(side_4)
        ...
        concat = Conv2D(1, kernel_size=(1,1), activation='sigmoid', name=self.name+'_concat', kernel_regularizer=l2(1e-4))(concat) 
