...
class RoadSurfaceNet(object):
    def __init__(self, input_shape=(512,512,3), name='surface'):
    ...
    def get_model(self):
        ...
        side_1 = tf.keras.activations.relu(side_1)
        ...
        ### Second output ###
        ### Size = W/2 * H/2 * 1 ###
        side_2 = Conv2D(2, kernel_size=(1,1), activation='sigmoid')(conv_2)
        side_2 = Conv2DTranspose(2, kernel_size=(2,2),activation='sigmoid', strides=(2,2), padding='same', name='surface_output_2')(side_2)
        side_2 = tf.keras.activations.relu(side_2)
        ...
        ### Third output ###
        ### Size = W/4 * H/4 * 1 ###
        side_3 = Conv2D(2, kernel_size=(1,1), activation='sigmoid')(conv_3)
        side_3 = Conv2DTranspose(2, kernel_size=(4,4),activation='sigmoid', strides=(4,4), padding='same', name='surface_output_3')(side_3)
        side_3 = tf.keras.activations.relu(side_3)
        ...
        ### Fourth output ###
        ### Size = W/8 * H/8 * 1 ###
        side_4 = Conv2D(2, kernel_size=(1,1), activation='sigmoid')(conv_4)
        side_4 = Conv2DTranspose(2, kernel_size=(8,8),activation='sigmoid', strides=(8,8), padding='same', name='surface_output_4')(side_4)
        side_4 = tf.keras.activations.relu(side_4)
        ...
        side_5 = Conv2DTranspose(2, kernel_size=(16,16),activation='sigmoid', strides=(16,16), padding='same', name='surface_output_5')(side_5)
        side_5 = tf.keras.activations.relu(side_5)
...
class SideNet(object):
    def __init__(self, input_shape=(512,512,2), name='centerline_net'):
        self.input_shape=input_shape
        self.name = name
    ...
    def get_model(self):
        ...
        ### Second output ###
        side_2 = Conv2D(2, kernel_size=(1,1), activation='sigmoid')(conv_2)
        side_2 = Conv2DTranspose(2, kernel_size=(2,2), activation='sigmoid', strides=(2,2), padding='same', name=self.name+'_output_2')(side_2)
        side_2 = tf.keras.activations.relu(side_2)
        ...
        ### Third output ###
        side_3 = Conv2D(2, kernel_size=(1,1), activation='sigmoid')(conv_3)
        side_3 = Conv2DTranspose(2, kernel_size=(4,4), activation='sigmoid', strides=(4,4), padding='same', name=self.name+'_output_3')(side_3)
        side_3 = tf.keras.activations.relu(side_3)
        ...
        ### Fourth output ###
        side_4 = Conv2D(2, kernel_size=(1,1), activation='sigmoid')(conv_4)
        side_4 = Conv2DTranspose(2, kernel_size=(8,8), activation='sigmoid', strides=(8,8), padding='same', name=self.name+'_output_4')(side_4)
        side_4 = tf.keras.activations.relu(side_4)
